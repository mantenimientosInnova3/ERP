...
SECRET_KEY = 'django-insecure-_7+10z#nc=31u=&^^+sgra)pg)5@%bg_-qaecybroag2rbjo52'
...
ALLOWED_HOSTS = [
    "127.0.0.1",
    "localhost",
    "192.168.1.213",   #  <----IP de tu PC propio de la red local
    "AdminInnova.pythonanywhere.com",
